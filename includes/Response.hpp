...
class Response {
	...
	public :
		...
		void setAsChunked(bool chunked); /////////////////////////////
		void setAsDone(); /////////////////////////////////
		void setHttpVersion(const std::string& version); // New method to set HTTP version
		
		// Response generation methods
		void buildResponse();
		void buildGetResponse(const std::string& file_path);
		void buildPostResponse();
		void buildDeleteResponse(const std::string& file_path);
